...
CREATE TABLE order_rist(
	order_no INT PRIMARY KEY
	,mem_no INT NOT NULL
	,item_no INT NOT NULL
	,item_count INT NOT NULL
	,total_price INT NOT NULL
	,CONSTRAINT fk_order_rist_mem_no FOREIGN KEY(mem_no)
		REFERENCES members(mem_no) ON DELETE CASCADE 
	,CONSTRAINT fk_order_rist_item_no FOREIGN KEY(item_no)
		REFERENCES item_list(item_no) ON DELETE NO ACTION
);
...
ALTER TABLE members DROP COLUMN age INT NOT NULL;
